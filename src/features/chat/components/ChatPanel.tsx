    ...
    <section className="flex h-full min-h-0 flex-col bg-neutral-950">
      <header className="flex h-12 shrink-0 items-center justify-between border-b border-neutral-800 px-4">
        ...
        <button
          ...
          type="button"
          className="inline-flex items-center gap-2 rounded-xl border border-neutral-800 bg-neutral-900 px-3 py-1.5 text-xs text-neutral-400 transition hover:border-neutral-700 hover:text-neutral-100"
        >
          <Trash2 size={14} />
          Clear
        </button>
      ...
      >
        <div className="mx-auto flex max-w-4xl items-end gap-2 rounded-2xl border border-neutral-800 bg-neutral-900 p-2">
          <textarea
            ...
            className="max-h-40 min-h-10 flex-1 resize-none bg-transparent px-2 py-2 text-sm leading-6 text-neutral-100 outline-none placeholder:text-neutral-600"
          />
        ...
        <p className="mx-auto mt-2 max-w-4xl px-1 text-[11px] text-neutral-600">
